        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="<c:url value="/CustomerServlet?method=query"/>" target="option">客户信息</a></dd>
                        <dd><a href="<c:url value="/add.jsp"/>" target="option">添加客户</a></dd>
                        <dd><a href="<c:url value="/query.jsp"/>" target="option">高级搜索</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item"><a href="<c:url value="/DevelopDoc.jsp"/>" target="option">开发日志</a></li>
            </ul>
        </div>
    </div>
